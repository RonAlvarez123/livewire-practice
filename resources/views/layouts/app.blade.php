...
<body class="antialiased">
    <nav class="flex bg-slate-700 text-white">
        ...
        <a href="/todo-list"
            class="py-4 px-6 hover:bg-slate-800 {{ request()->routeIs('todo-list') ? 'bg-slate-800' : '' }}">Todo-list</a>
        ...
        <a href="/products"
            class="py-4 px-6 hover:bg-slate-800 {{ request()->routeIs('products') ? 'bg-slate-800' : '' }}">Products</a>
    </nav>
